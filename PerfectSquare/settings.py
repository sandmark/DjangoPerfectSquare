...
#   This code does nothing if the environment is in development or test.
#   With `dj_database_url` package, this updates DATABASES definition
#   when only in production environment.
