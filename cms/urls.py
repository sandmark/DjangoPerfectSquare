...
urlpatterns = [
    ...
    path('watch/<int:pk>/',
         login_required(views.WatchView.as_view(template_name='cms/watch_html5.haml')),
         name='watch'),
    path('watch/<int:pk>/flash/',
         login_required(views.WatchView.as_view(template_name='cms/watch_flash.haml')),
         name='watch_flash'),
    path('watch/<int:pk>/jw/',
         login_required(views.WatchView.as_view(template_name='cms/watch_jw.haml')),
         name='watch_jw'),
